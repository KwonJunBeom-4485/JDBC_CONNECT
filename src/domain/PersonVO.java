...
public class PersonVO {
    ...
    public PersonVO(String person_userId, String person_userPw, String person_userName,
            String person_userEmail, String person_phone1, String person_phone2, byte person_age, String person_address1,
    ...
    public String toString() {
        return "PersonVO [person_id=" + person_id + ", person_age=" + person_age + ", person_userId=" + person_userId
                + ", person_userPw=" + person_userPw + ", person_userName=" + person_userName + ", person_userEmail="
                + person_userEmail + ", person_phone1=" + person_phone1 + ", person_phone2=" + person_phone2
                + ", person_address1=" + person_address1 + ", person_address2=" + person_address2 + ", regDate="
